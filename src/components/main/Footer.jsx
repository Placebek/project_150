...
function Footer() {
    return (
        <div className='bg-[#F4F4F4] w-full h-[25vw] p-[60px] px-[120px]'>
            <div className='flex flex-row gap-28'>
                <div className='flex flex-col gap-y-3'>
                    <div>
                        <img src={logoMiniBlack} alt="" className='w-[9vw]' />
                    </div>
                    <div className='font-eastman_medium'>klever.kz@gmail.com</div>
                    <div className='font-eastman_medium'>+7(700) 707-7000</div>
                </div>
                <div className='font-eastman_regular flex flex-col gap-3 text-[17px] ml-[5vw]'>
                    <div>О нас</div>
                    <div>Блог</div>
                    <div>Безопасность</div>
                    <div>Контакты</div>
                </div>
                <div className='font-eastman_regular flex flex-col gap-3 text-[17px]'>
                    <div>Вакансии</div>
                    <div>Услуги</div>
                    <div>Курьеры</div>
                    <div>Трекинг</div>
                </div>
                <div className='font-eastman_medium flex flex-col gap-3 text-[17px]' >
                    <div>Политика конфиденциальности</div>
                    <div>Положения и условия</div>
                    <div>Подпишитесь на рассылку новостей</div>
                    <div className='flex flex-row gap-0 items-center '>
                        <div>
                            <input type="text" className='rounded-l-[10px] h-[6vh] placeholder:font-eastman_regular pl-3' placeholder='e-mail' />
                        </div>
                        <div className='bg-[#FF0000] h-[6vh] flex items-center px-4 rounded-r-[10px] cursor-pointer'>
